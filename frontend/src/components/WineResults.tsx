...
interface WineResultsProps {
    results: WineCalculationResults;
}

const WineResults: React.FC<WineResultsProps> = ({ results }) => {
    return (
        <div className="results-panel">
            <div className="panel-header">
                <h2><i className="fas fa-clipboard-list"></i> Resultados de la Receta de Vino</h2>
            </div>
            <div className="results-grid">
                <div className="result-card">
                    <h3><i className="fas fa-weight"></i> Ingredientes Principales</h3>
                    <div className="ingredient-item">
                        <span className="ingredient-name">Uva:</span>
                        <span className="ingredient-amount">{results.uva.toFixed(2)} kg</span>
                    </div>
                    <div className="ingredient-item">
                        <span className="ingredient-name">Azúcar Adicional:</span>
                        <span className="ingredient-amount">{results.azucar.toFixed(2)} kg</span>
                    </div>
                    <div className="ingredient-item">
                ...
                <div className="result-card">
                    <h3><i className="fas fa-beer"></i> Perfil del Vino</h3>
