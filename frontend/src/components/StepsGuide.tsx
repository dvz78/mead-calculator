...
const StepsGuide: React.FC<StepsGuideProps> = ({ tipo }) => {
    ...
    const stepsHidromiel: Step[] = [
        {
            ...
            description: "Calienta 3/4 partes del agua total hasta 40-50°C. Agrega la miel poco a poco mientras agitas para disolverla completamente. No hiervas la miel.",
    ...
    return (
        <div className="steps-guide">
            <div className="steps-header">
                <h3><i className="fas fa-list-ol"></i> Guía de Pasos para {tipo === 'hidromiel' ? 'Hidromiel' : 'Vino'}</h3>
                <p>Sigue estos pasos para elaborar tu bebida fermentada</p>
            </div>
                ...
                {steps.map(step => (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <i className={`fas fa-chevron-${completedSteps.includes(step.id) ? 'up' : 'down'}`}></i>
                            </button>
                        </div>
                        
                        <div className={`step-content ${completedSteps.includes(step.id) ? 'expanded' : ''}`}>
